...
generateSiteTransferChart = function (id ,params) {
    siteTransferUrlToData("/line/"+params.lineNo+"/" + params.direction + "/day/stationInfo", params, id, siteTransferChartOptions)
}
...
//根据URL获取数据
siteTransferGetSourceData = function(url,params, id, newOptions) {
    //ajax请求数据
    $.ajax({
        type: 'GET',
        url: url ,
